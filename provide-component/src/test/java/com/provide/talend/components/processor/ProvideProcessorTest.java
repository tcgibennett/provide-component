...
public class ProvideProcessorTest {
    ...
    public void map() throws IOException {
        ...
        final ProvideProcessorConfiguration configuration =  new ProvideProcessorConfiguration();

        // We create the component processor instance using the configuration filled above
        final Processor processor = COMPONENT_FACTORY.createProcessor(ProvideProcessor.class, configuration);
